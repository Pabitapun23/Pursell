                        ...
                        <li class="list">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content" x-placement="right-start">
                                    ...
                                    <button class="dropbtn"><a href="{{ route('displaycat', $sub->name) }}">{{ $sub->name }}</a>
                                    </button>
                                    @endif
                                    @endforeach
                                </div>
                            ...
                            <form action="/searchData">
                                <div class="input-group rounded">
                                    ...
                                    <div class="search_form">
                                        <input type="text" name="search" id="search-web" class="form3" placeholder=" Search All Items " aria-label="Search" aria-describedby="search-addon" />
                                    ...
                                    <div class="location"><button class="locbutton"><i class="fa fa-search" aria-hidden="true"></i></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="search1">
                    <form action="/searchData">
                        <div class="input-group rounded">
                            <div class="searchbutton"> <button class="searchbutton"></button></div>
                            <div class="search_form">
                                <input type="text" name="search" id="search-mobile" class="form3" placeholder=" Search All Items " aria-label="Search" aria-describedby="search-addon" />
                            ...
                            {{-- <input type="search" class="form2" placeholder=" All Location" aria-label="Search"
                                aria-describedby="search-addon" /> --}}
                            <div class="location"><button class="locbutton" type="submit"><i class="fa fa-map-marker" aria-hidden="true"></i></button></div>
                        </div>
                    </form>
                </div>
