            ...
            <div class="container py-5">
                <div class="row h-100 align-items-center py-5">
                    <div class="col-lg-6">
                        ...
                        <p class="lead text-muted mb-0" style="font-size: 22px; margin-top:20px;">Pursell is an online
            ...
            <div class="container py-5">
                <div class="row align-items-center mb-5">
                    <div class="col-lg-6 order-2 order-lg-1">
                        <h2 class="font-weight-dark" style="color:#D02020; font-size: 45px; font-weight: bolder;">Find What
                            You Want Easily</h2>
                        <p class="lead text-muted mb-4" style="font-size: 22px; margin-top:20px;">We uses the
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <h2 class="font-weight-dark"
                            ...
                            Hand</h2>
                        <p class="lead text-muted mb-4" style="font-size: 22px; margin-top:20px;">At Pursell You have
                ...
                <div class="row text-center">
                    ...
                    <div class="col-xl-4 col-sm-6 mb-5">
                        <div class="bg-white rounded shadow-sm py-5 px-4">
                            <img src="images/bikal.jpg" alt="" width="150" style="margin-bottom: 20px;"
                                class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                            <h4 class="mb-0 mt-4">Bikalpa KC</h4>
                            <ul class="social mb-0 list-inline mt-3">
                                <li class="list-inline-item"><a href="https://www.facebook.com/bikku.rocky/"
                                        class="social-link"><i class="fa fa-facebook-f" style="color:#d02020"></i></a></li>
                                <li class="list-inline-item"><a href="https://www.instagram.com/bikal_kc21/"
                                        class="social-link"><i class="fa fa-instagram" style="color:#d02020"></i></a></li>
                                <li class="list-inline-item"><a href="https://www.linkedin.com/in/bikalpa-kc-505205192/"
                                        class="social-link"><i class="fa fa-linkedin" style="color:#d02020"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- End-->
                    ...
                    <div class="col-xl-4 col-sm-6 mb-5">
                        <div class="bg-white rounded shadow-sm py-5 px-4"><img src="images/pabita.jpeg" alt=""
                                ...
                                class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                            <h4 class="mb-0 mt-4">Pabita Pun</h4>
                            <ul class="social mb-0 list-inline mt-3">
                    ...
                    <div class="col-xl-4 col-sm-6 mb-5">
                        <div class="bg-white rounded shadow-sm py-5 px-4"><img src="images/rabita.jpeg" alt=""
                                width="150" style="margin-bottom: 20px;"
                                class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
                            <h4 class="mb-0 mt-4">Rabita Chhantyal</h4>
                            <ul class="social mb-0 list-inline mt-3">
                                <li class="list-inline-item"><a
                                        href="https://www.facebook.com/profile.php?id=100009394778933"
                                        class="social-link"><i class="fa fa-facebook-f" style="color:#d02020"></i></a>
                                </li>
                                <li class="list-inline-item"><a href="https://www.instagram.com/rabeeee5/"
                                        class="social-link"><i class="fa fa-instagram" style="color:#d02020"></i></a>
                                </li>
                                <li class="list-inline-item"><a
