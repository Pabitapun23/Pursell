            ...
            <div class="col-lg-6 col-12">
                <div class="card shadow mt-2 mx-3">
                    <div class="card-header p-0 position-relative mt-3 mx-4 z-index-2 bg-transparent">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1" style="height: 16rem">
                            <img src="{{ asset($organizations->image) }}" height="230" width="100%" alt_src="No Image Found">
                        </div>
                    </div>
