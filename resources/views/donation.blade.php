...
<body>
    ...
    <div class="donation-container-fluid" style="background-color: rgb(250, 245, 236); overflow:hidden;">
        <div class="row">
            <div class="col-lg-6">
                <div class="donate-cover" style="background-image: url('images/donate.JPG'); background-size:cover; background-position:center; background-repeat:no-repeat;">
                </div>
            </div>
            <div class="col-lg-6">
    ...
    <div class="card-footer mx-4">
        <ul class="list-group mx-2 my-3">
            <li class="list-group-item">Telephone: &nbsp; <span style="color: grey">{{ $data->telephone }}
                </span></li>
            <li class="list-group-item">Email: &nbsp; <span style="color: grey">{{ $data->email }}
                </span></li>
            <li class="list-group-item">Website: &nbsp; <span style="color: grey">{{ $data->website }}</span></li>
        </ul>
    </div>
        ...
        <div class="card mx-2 mb-4" style="height: 100%; ">
            <a href="{{ asset($data->image) }}" style="color:#D02020; text-decoration:none;">
                ...
                <a href="{{ url('donation-view/' . $data->id) }}" class="my-2">
                    <button type="submit" class="btn float-end px-4 py-2" style="background-color: #fd7e14; color:white;">View</button>
                </a>
            </a>
        </div>
        @endforeach
