                                ...
                                <div class="row">
                                    <div class="col-xl-3 ">
                                        ...
                                        <div class="img-square-wrapper">
                                            <img class="responsive" src="{{ asset($img->image) }}" name="img" alt="Card image cap">
                                        </div>
                                        @endforeach
                                    </div>
                                    ...
                                    <div class="col-xl-9">
                                        <div class="card-body">
                                            ...
                                            <ul class="list-group list-group-horizontal ">
                                                <li class="list-group-item border-0" style="font-weight: bolder;"><i class="fa-solid fa-money-bill-wave" name="price" style="margin-right: 4px;"></i>Price
                                                    : {{ $data->price }}</li>

                                                <li class="list-group-item border-0" name="condition" style="font-weight: bolder;">
                                                    Condition:
                                                    {{ $data->condition }}
                                                </li>
                                                <li class="list-group-item border-0" name="negotiable" style="font-weight: bolder;">
                                                    Negotiable:
                                            ...
                                            <hr>
                                            <ul class="list-group list-group-horizontal ">
                                                <li class="list-group-item border-0" name="username" style="color: grey;"><i class="fa-regular fa-user" style="margin-right: 8px;"></i>{{ $data->user->name }}
                                                </li>
                                                <li class="list-group-item border-0" name="address" style="color: grey;"><i class="fa-solid fa-location-dot" style="margin-right: 8px;"></i>{{ $data->address }}</li>
                                                <li class="list-group-item border-0" style="color: grey;">
                                                    @if (auth()->user()->id != $data->user->id)
                                                    <button id="wishlistBtn" class="pt-1 pb-2 px-1 mt-0 float-end" style="border:none; background-color:white;">
                                                        <i class="fa-solid fa-bookmark fa-lg" id='heart' style="color:gray; color:{{Auth::user()->wishlists()->where('post_id',$data->id)->count() > 0 ? '#d02020': '' }}">
                                                        </i>
                                                    </button>
                                                    <input type="hidden" name="id" id="postid" value="{{ $data->id }}">
                                                    @endif
                                            </ul>
                                        </div>
                                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div id="formdiv">
                            ...
                            <p style="margin-left: 25px;margin-bottom:5px;font-family: Algeria; ">
                                Sort Ads By</p>
                            <select class="form-select" name="sort" style="height: 28px;padding-bottom:
                            ...
                            <select class="form-select" name="condition" style="height: 28px;padding-bottom:3px;margin-bottom: 10px;font-size:12px;width: 90%; margin-left:25px;color: grey;">
                            ...
                            <select class="form-select" name="address" style="height: 28px;padding-bottom:
                                        3px;margin-bottom: 10px;font-size:
                                        12px;width: 90%; margin-left:25px;
                                        color: grey;" id="address">
                            ...
                            <div class="row" name="price">
                                <div class="col">
                                    <input type="number" min="1" name="min_price" message="No
                                                products for free!" class="form-control" name="minprice" style="height:
                                                28px;padding-bottom:
                                                3px;margin-bottom:
                                                10px;font-size: 12px;width: 90%;
                                                margin-left:25px; color: grey;" placeholder="Min" aria-label="First name">
                                </div>
                                <div class="col">
                                    <input type="Number" min="1" name="max_price" message="No
                                                products for free!" class="form-control" name="maxprice" style="height:
                                                28px;padding-bottom:
                                                3px;margin-bottom:
                                                10px;font-size: 12px;width: 90%;
                                                color: grey;" placeholder="Max" aria-label="Last name">
                                </div>
                            </div>
                            <p style="margin-left: 25px;margin-bottom:5px;font-family: Algeria; ">
                                Negotiable</p>
                            <select class="form-select" name="negotiable" style="height: 28px;padding-bottom:
                                        3px;margin-bottom: 10px;font-size:
                                        12px;width: 90%; margin-left:25px;
                                        color: grey;">
                            ...
                            <div class="row" style="padding-top:24px;">
                                <div class="clear">
                                    <button type="submit" class="bottombutton" style="font-family:Algeria;" id="filterbtn">Filter
                                    </button>
                                </div>
                            </div>
                        </div>
