...
<head>
    ...
    <!-- CSS Link -->
    <link rel="stylesheet" href="../css/resetpassemail.css">
</head>
                        ...
                        <div class="card-body p-0">
                            <div class="row">
                                <div class="col-lg-12 col-12">
                                    ...
                                    <p class="form-title mx-2">Request an email reset link</p>
                                    @if (session('status'))
                                    ...
                                    <form method="POST" action="{{ route('password.email') }}">
                                        ...
                                        <div class="form-row pt-4 mx-2">
                                            <div class="input-group flex-nowrap">
                                                ...
                                                <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Your Email" aria-label="Email" aria-describedby="addon-wrapping">
                                                @error('email')
