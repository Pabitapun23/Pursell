            ...
            <div class="col-lg-4 col-md-6 mt-2 mb-4">
                <div class="card shadow mx-4 z-index-2">
                    <div class="card-header p-0 position-relative mt-2 mx-4 z-index-2 bg-transparent">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1" style="height: 14rem">
                            <img src="{{ asset($data->image) }}" height="200" width="100%" alt_src="notfound.png">
                        </div>
                    </div>
