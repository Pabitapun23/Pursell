        ...
        <div class="profile-container mt-4">
                ...
                <div class="row my-3 mx-5 mb-5 justify-content-around">
                    <div class="col-lg-5 col-12">
                        <div
                            ...
                            <div
                                class="d-grid gap-2 d-md-block ps-4 ms-2 d-flex flex-row justify-content-between align-items-end">
                                <p class="p-0"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                    ...
                                    @if (auth()->user()->id == $id)
                                        <button type="button" class="btn editbutton ms-3 mb-3 float-end"
                                        ...
                                        <div class="row">
                                            @foreach ($wishdatas as $wishdata)
                                                @foreach ($wishdata->post->images->take(1) as $img)
                                                    <div class="col-lg-4 col-12 justify-content-center">
                                                        <div class="card m-1">
                                                            <a href="{{ route('singlepost', $wishdata->post->id) }}"
                                                                style="color:#D02020; text-decoration:none;">
                                                                <img class="card-img-top " src="{{ asset($img->image) }}"
                                                                    alt="" style="object-fit:cover; height:15vh;">
                                                                <div class="card-body">
            ...
            <div class="d-md-none d-block">
                <div class="row mb-3 justify-content-around">
                    <div class="col-lg-5 col-12">
                        <div
                            class="profile-content shadow mt-3 px-5 pb-5 pt-3 ps-2 bg-body rounded justify-content-center">
                            <div>
                                @if ($users->profileimg == null)
                                    <img src="{{ URL::asset('/images/user.png') }}" alt="avatar"
                                        class="rounded-circle ms-3" style="width:100px;height:100px;object-fit:cover;">
                            ...
                            <div
                                class="d-grid gap-2 d-md-block ps-4 ms-2 d-flex flex-row justify-content-between align-items-end">
                                <div>
                                    <p class="p-0"><svg xmlns="http://www.w3.org/2000/svg" width="18"
                                            height="18" fill="#d02020" class="bi bi-telephone-fill"
                                            viewBox="0 0 16 16">
                                            <path fill-rule="evenodd"
                                                d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z" />
                                        </svg> &nbsp; <span style="color: gray;">{{ $users->phoneno }}</span>
                                ...
                                <div>
                                    @if (auth()->user()->id == $id)
                                        <button type="button" class="btn editbutton ms-3 mb-3" data-bs-toggle="modal"
