                        ...
                        <li class="list">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content" x-placement="right-start">
                                    ...
                                    <button class="dropbtn"><a href="{{ route('displaycat', $sub->name) }}">{{ $sub->name }}</a> </button>
                                    @endif
                                    @endforeach
                                </div>
                        ...
                        <div class="search1">
                            <div class="input-group rounded">
                                ...
                                <div class="search_form">
                                    <input type="text" name="search" id="search" class="form3" placeholder="Search All Items " aria-label="Search" aria-describedby="search-addon" />
                                    <div id="post_list">
                                    </div>
                                </div>
