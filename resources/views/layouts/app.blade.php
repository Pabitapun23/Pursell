...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Josefin+Sans:wght@200&family=Roboto:wght@300&display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Josefin+Sans:wght@200&family=Roboto:wght@300;500;700&display=swap" rel="stylesheet">
...
<body>
    ...
    <div id="app">
        ...
        <ul class="nav nav-fill fixed-bottom d-lg-none pt-2" id="mobile-bottom-navbar" style=" background:#fbf9f9; border-bottom:1px solid #F53535;    box-shadow: 0 0 5px 1px #F53535; height: 55px; ">
            <li class="nav-item">
                <a class="nav-link text-capitalize d-flex flex-column justify-content-center align-items-center" href="{{ route('welcome') }}">
                    <button class="home">
            ...
            @auth
            <li class="nav-item">
                <a class="nav-link text-capitalize d-flex flex-column justify-content-center align-items-center" href="javascript:void(0);">
            ...
            <li class="nav-item">
                <a class="nav-link text-capitalize d-flex flex-column justify-content-center align-items-center" href="{{ route('postform') }}">
            ...
            @if (Route::has('login'))
            <li class="nav-item">
                <a class="nav-link pt-0 text-capitalize d-flex flex-column justify-content-center align-items-center" href="{{ route('login') }}">
            ...
            @else
            <li class="nav-item">
                <a class="nav-link pt-0 text-capitalize d-flex flex-column justify-content-center align-items-center" href="{{ route('profile', Auth::user()->id) }}">
                    <button class="profile">
                        <i class="fa fa-user" aria-hidden="true"></i>
                    </button>
                    <span style="color:black" class="small">
        ...
        <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
            <div class="navbar-container-fluid">
                <a href="/">
                    <img src="{{ asset('images/logo.png') }}" style="height:75px ; width:80px; margin-right:139px; margin-top:0px; margin-bottom:-10px; margin-left: -10px;">
                </a>
                <div class="d-lg-flex justify-content-end collapse navbar-collapse float-end" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="menu">
                        ...
                        <li class="nav-item px-2 dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <button class="btn2 mt-2">
                                    ...
                                    <span class="message-recieved badge badge-danger navbar-badge notification-count rounded-circle" style="display:none;">1</span>
                                </button>
                                <!-- <p class="message-recieved " style="display:none;">1</p> -->
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end position-absolute px-3 py-3" aria-labelledby="navbarDropdown" style="background-color: white; padding:5px;">
                        ...
                        @else
                        <li class="nav-item">
                            <a class="nav-link active text-capitalize d-flex flex-column justify-content-center align-items-center" href="{{ route('profile', Auth::user()->id) }}">
                        ...
                        <li class="nav-item py-2 dropdown">
                            <a id="navbarDropdown" class="nav-link dropdown-toggle mt-0" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre style="padding-top: 3px;">
                                {{ Auth::user()->name }}
                            </a>

                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown" style="background-color: white;">
                                <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();" style="background-color: white; padding:5px; padding-left:10px;">
                                    {{ __('Logout') }}
                                </a>
