                                            ...
                                            <div class="image-row">
                                                <div class="col-lg-12 col-12">
                                                    <div class="photo_item justify-content-center">
                                                        ...
                                                        <input type="file" accept="image/*" name="images[]" id="files" multiple="multiple" class="d-none">
                                            ...
                                            <div class="row justify-content-around">
                                                ...
                                                <div class="col-lg-8 col-12">
                                                    <div>
                                                        ...
                                                        <input type="date" class="form-control" name="party" placeholder="Pick a date" id="datePickerId" required />
