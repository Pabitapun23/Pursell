                        ...
                        <div class="row1" style="text-align: center;">
                            ...
                            <div class="search1">
                                <div class="input-group rounded">
                                    <div class="searchbutton"> <button class="searchbutton"><i class="fa fa-search"
                                                aria-hidden="true"></i></button></div>
                                    <div class="search_form">
                                        <input type="text" name="search" id="search" class="form3"
                                    ...
                                    <input type="search" class="form4" placeholder="   All Location" aria-label="Search"
                                        aria-describedby="search-addon" />
                                    <div class="location"><button class="locbutton"><i class="fa fa-map-marker"
