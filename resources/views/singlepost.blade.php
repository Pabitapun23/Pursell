            ...
            <div class="col-md-4 ">
                <div class="card" style="width: 100%; height: 95%;background-color: #FDFDFD; margin-top: 40px;">
                    ...
                    <div class="borderless">
                        <ul class="list-group">
                            <div class="row" style="width: 100%; margin-left: 0px;">
                                ...
                                <div class="col-md-6">
                                    <li class="list-group-item border-0" style="font-family: 'Alegreya Sans SC';color:grey;  font-size: 21px;"><i class="fa-solid fa-money-bill" style="color:green;"></i>Rs.
                                        {{ $post->price }}
                                    </li>
                                </div>
                            </div>
                        ...
                        <ul class="list-group">
                            <div class="row" style="width: 100%; margin-left: 0px;">
                                <div class="col-md-6">
                                    <li class="list-group-item border-0" style="color: grey; font-family: 'Alegreya Sans SC'; margin-top: -14px;">
                                        {{ $post->condition }}
                                    </li>
                                </div>
                                <div class="col-md-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <button class="btnad" data-bs-toggle="modal" data-bs-target="#staticBackdrop" style="margin-bottom: 10px; margin-top: 10px; margin-left: -10px;">
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="cardsimi">
                                    ...
                                    <ul class="list-group list-group-horizontal " style="margin-top: -10px;">
                                        ...
                                        <li class="list-group-item border-0" style="color: grey; font-size:12px">{{ $relatedpost->condition }}
                                        </li>
                                    </ul>

                                    <ul class="list-group list-group-horizontal " style="margin-top: -10px;">
                                        <li class="list-group-item border-0" style=" font-size: 12px; font-weight: 700;">
                                            {{ $relatedpost->price }}
                                        </li>
        ...
        $('#submitButton').click(function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#msgdisplay').append('<div class="d-flex flex-row justify-content-end mb-4"> <div class="p-3 me-3 border" style="border-radius: 15px; background-color: #fbfbfb;">  <p class="small mb-0 " id="msgdisplay">' + text + '</p>  </div> <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava2-bg.webp" alt="avatar 1" style="width: 45px; height: 100%;"> </div>');
                },
            });
        })
    });
