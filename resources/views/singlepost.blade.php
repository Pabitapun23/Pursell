                            ...
                            <div class="card-footer mx-4 mb-2 py-0" style="background-color: white;">
                                ...
                                <p class="btnotherad">
                                    <a href="{{ route('profile', $post->user->id) }}"
                                        style="text-decoration: none;color:gray ; font-size: 12px;">{{ $post->count() }}
                                        Other Ads</a>
                                </p>
                                ...
                                @if (auth()->user()->id != $post->user->id)
                                    <button id="wishlistBtn" class="py-2 px-1 float-end"
                                        style="border:none; background-color:white;">
                                        <i class="fa-solid fa-bookmark fa-2x" id='heart'
                                            style="color:gray; color:{{ Auth::user()->wishlists()->where('post_id', $post->id)->count() > 0? '#d02020': '' }}">
                                        </i>
                                    </button>
