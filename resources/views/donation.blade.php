...
<body>
    ...
    <div class="donation-container-fluid" style="background-color: rgb(250, 245, 236); overflow:hidden;">
        <div class="row">
            <div class="col-lg-6">
                <div class="donate-cover" style="background-image: url('images/donate_cover.JPG'); background-size:cover; background-position:center; background-repeat:no-repeat;">
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="d-flex position-relative mt-2 mb-3 owl-carousel owl-theme">
            ...
            <div class="card mx-2 mb-4" style="height: 100%; ">
                <a href="{{ url('donation-view/' . $data->id) }}" style="color:#D02020; text-decoration:none;">
                    ...
                    <div class="card-body px-1 pb-0">
                        ...
                        <ul class="list-group mx-2 my-1">
                            <li class="list-group-item pt-2">Telephone: &nbsp; <span style="color: grey">{{ $data->telephone }}
                                </span></li>
                            <li class="list-group-item pt-1">Email: &nbsp; <span style="color: grey">{{ $data->email }}
                                </span></li>
                            <li class="list-group-item pt-1">Website: &nbsp; <span style="color: grey">{{ $data->website }}</span></li>
                        </ul>
                    </div>
                    <a href="{{ url('donation-view/' . $data->id) }}" class="my-2 me-2">
                        <button type="submit" class="btn float-end px-3 py-2" style="background-color: #fd7e14; color:white;">View</button>
                    </a>
                </a>
            </div>
            @endforeach
