                        ...
                        <div class="card shadow mt-2 mx-3">
                            ...
                            <div class="card-body p-0">
                                <div class="row m-0 mt-4 px-2">
                                    ...
                                    <div class="col-md-6">
                                        <h4 class="fw-normal float-end"><i class="fa-solid fa-money-bill"
                                                style="color:green;"></i>
                                            Rs.{{ $post->price }}
                                        </h4>
                                        <br>
                                        <p class="fw-normal float-end pt-1 ps-5" style="color: grey;">
                                            {{ $post->condition }}
                                        </p>
                                    </div>
                            ...
                            <div class="card-footer mx-4 mb-2 py-0" style="background-color: white;">
                                ...
                                <p class="btnotherad">
                                    <a href="#" style="text-decoration: none;color:gray ; font-size: 12px;">30
                                        Other Ads</a>
                                </p>
                                <p class="phn"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                ...
                                <button class="py-2 px-3 mb-4 btnad rounded" type="button" data-bs-toggle="modal"
                                    data-bs-target="#staticBackdrop" style="color: white; background-color:#D02020;">
                                    <i class="fa-solid fa-comments"></i> Chat
                                </button>
                                <button class="py-2 px-3 ms-2 btnad rounded" type="button"
                                    style="color: white; background-color:#D02020;"><i class="fa-solid fa-bookmark">
                                    </i> Save </button>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="card" id="chat1" style="border-radius: 15px;">
                                                    ...
                                                    <form action="{{ route('chat', $post->id) }}" method="POST">
                                                        ...
                                                        <input type="hidden" name="id" id="id"
                                                            value="{{ $post->id }}">
                                                        <div class="card-body" id="msgdisplay"
                                                            style="position: relative; height: 400px;overflow:scroll;overflow-x: hidden;">
                                                            <!-- <p>
                                                            ...
                                                            <!-- <div class="d-flex flex-row justify-content-start mb-4">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    <div class="p-3 ms-3" style="border-radius: 15px; background-color: rgba(57, 192, 237,.2);">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        <p class="small mb-0 " id="msgdisplay"></p>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    </div>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                </div> -->
                                                        ...
                                                        <div
                                                            class="card-footer row text-muted d-flex justify-content-start align-items-center p-3">
                                                            <div class="col-2">
                                                        ...
                                                        <!-- <div class="form-outline">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                <input type="text" class="form-group" name="text" id="text">
                                        ...
                                        <div class="minimal-tabs">
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li class="nav-item" role="presentation"><a class="nav-link"
                                                        role="tab" data-bs-toggle="tab" href="#tab-1"> <i
                                                ...
                                                <li class="nav-item" role="presentation"><a class="nav-link"
                                                        role="tab" data-bs-toggle="tab" href="#tab-2"> <i
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade show active" role="tabpanel" id="tab-1">
                                                    ...
                                                    <ul class="list-group">
                                                        ...
                                                        <li class="list-group-item py-1">Delievery : <span
                                                                style="color: gray;"> &nbsp;
                                                                @if ($post->delivery == '0')
                                                                    No
                                                                @else
                                                        ...
                                                        <li class="list-group-item py-1">Negotiable: <span
                                                                style="color: gray;"> &nbsp;
                                                    ...
                                                    <ul class="list-group">
                                                        ...
                                                        <li class="list-group-item py-1 pb-3">Waranty : <span
                                                                style="color: gray;">
                                                                &nbsp; @if ($post->warranty == '0')
                                                                    No
                                                                @else
                                                ...
                                                <div class="tab-pane" role="tabpanel" id="tab-2">
                                                    <div class="comment-box ml-2">
                                                        ...
                                                        <form action="{{ route('comment', $post->id) }}" method="POST"
                                                            ...
                                                            <button type="submit"
                                                                class="py-1 px-3 mt-3 btnad rounded float-end"
                                                                id="addCommentBtn"
                                                                style="color: white; background-color:#D02020;"> Post
                                                            </button>
                                                        </form>
                                                    </div>
                                                    <br>
                                                    ...
                                                    <div class="commentsec">
                                                        ...
                                                        @foreach ($post->comments as $comment)
                                                            ...
                                                            <p
                                                                style="font-style: italic; font-size:15px; color:gray; float:right;">
                                        ...
                                        <div class="card shadow mx-2 mt-2 mb-4" style="height: 100%; ">
                                            <a href="{{ route('singlepost', $relatedpost->id) }}"
                                                ...
                                                <img class="card-img-top " src="{{ asset($img->image) }}" alt=""
                                                    style="height: 20vh">
                                                <div class="card-body">
                                                    <h5 class="card-title mt-0" style="color:#D02020;">
                                                        {{ $relatedpost->title }}
                                                    </h5>
